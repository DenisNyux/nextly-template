...
export function Video({ videoId }: Readonly<VideoProps>) {
  ...
  return (
    <Container>
      <div className="relative w-full h-[500px] max-w-4xl mx-auto overflow-hidden lg:mb-20 rounded-2xl bg-indigo-300 cursor-pointer " style={{backgroundImage: 'linear-gradient(83.11deg,#318dd0 30.17%,#bb2395 80.4%)'}}>
        {!playVideo && (
          <button
